        ...
        <div className="absolute top-[507px] left-[69px] w-[269px] h-[372.35px] text-center text-midnightblue">
          <div className="absolute top-[0px] left-[0px] w-[269px] h-[372.35px]">
            ...
            <div className="absolute top-[109.72px] left-[21.24px] w-[219.45px] h-[114.81px] text-left">
              ...
              <div className="absolute top-[0px] left-[0px] leading-[13.87px] inline-block w-[53.8px]">
                Name*
              </div>
              <div className="absolute top-[67.25px] left-[0px] leading-[13.87px] inline-block w-[83.53px]">
                Phone Number*
              </div>
            </div>
            <div className="absolute top-[252.72px] left-[126.71px] w-[15.9px] h-[8.82px]">
              <div className="absolute top-[0px] left-[1px] bg-lightsteelblue w-[11.06px] h-[1.42px] [transform:_rotate(45deg)] [transform-origin:0_0]" />
              <div className="absolute top-[7.82px] left-[7.08px] bg-lightsteelblue w-[11.06px] h-[1.42px] [transform:_rotate(-45deg)] [transform-origin:0_0]" />
            </div>
          ...
          <div className="absolute top-[299.44px] left-[89.9px] text-[8.49px] tracking-[1.42px] leading-[28.32px] uppercase text-white inline-block w-[89.19px]">
            register
          </div>
        </div>
        <div className="absolute top-[42px] left-[299.85px] w-[48.15px] h-[38.52px] text-[5.57px]">
          ...
          <div className="absolute top-[0px] left-[5.57px] w-[41.05px] h-[34.97px]">
            ...
            />
            <div className="absolute top-[2px] left-[2.57px] text-[6.59px] leading-[6.89px] capitalize text-right inline-block w-5">
              Login
            </div>
            <div className="absolute top-[16.72px] left-[0px] leading-[9.93px] text-midnightblue inline-block w-[38.52px] h-[9.12px]">
              English
            </div>
            <div className="absolute top-[25.85px] left-[0px] leading-[9.93px] text-lightsteelblue inline-block w-[38.52px] h-[9.12px]">
              Kinyarwanda
            </div>
          </div>
        </div>
